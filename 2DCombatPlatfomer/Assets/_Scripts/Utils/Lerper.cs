...
{
    public static void LerpFloat(this MonoBehaviour mb,float start, float target, float lerpDuration, System.Action<float> action, AnimationCurve curve = null){
        mb.StartCoroutine(LerpFloatRoutine(start,target,lerpDuration,action,curve));
    }
    ...
    static IEnumerator LerpFloatRoutine(float start, float target, float lerpDuration, System.Action<float> action, AnimationCurve curve = null){
